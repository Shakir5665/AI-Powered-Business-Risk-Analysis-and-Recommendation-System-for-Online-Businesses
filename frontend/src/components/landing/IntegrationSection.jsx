...
const rightIntegrations = [
  {
    id: "gemini",
    name: "Gemini AI",
    description: "LLM-powered risk analysis",
  ...
  },
  {
    id: "react",
    name: "React",
    description: "Interactive frontend dashboard",
          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
              ...
              >
                ...
                <span className="text-[#138E5F] text-[14px] font-medium font-sans">Integrations & Tech Stack</span>
              </motion.div>
              ...
              >
                ...
                <span className="italic text-[rgba(0,0,0,0.40)]">seamlessly</span>
              </motion.h2>
              ...
              >
                RiskAI connects to major e-commerce platforms and is powered by a modern AI tech stack — so you always get accurate, real-time business risk insights.
              </motion.p>
            </div>
            ...
            <div className="flex flex-col items-center mt-12 md:mt-[80px] gap-6 md:gap-8">
              ...
              >
                Powered by{" "}
                <span className="font-semibold text-[#138E5F]">Google Gemini AI</span>{" "}
                and built on a modern{" "}
                <span className="font-semibold text-[#138E5F]">FastAPI + React</span>{" "}
